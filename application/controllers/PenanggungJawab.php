...
class PenanggungJawab extends CI_Controller
{
    ...
    public function save()
    {
        ...
        try {
            if (empty($idDaftar)) {
                ...
                $data_update['StatusAktivasi'] = 'Aktif'; 
                $data_login = [
                    'NamaLengkap' => $NamaLengkap,
                    'NIK' => $NIK,
                    'JenisAkun' => 'Penanggung Jawab',
    ...
    private function kirim_email_notifikasi($email_tujuan, $nama, $nik, $password_biasa, $jenis_akun)
    {
        ...
        $this->email->subject('Akun ' . $jenis_akun . ' Anda Telah Dibuatkan - Sapa Baru');
        ...
        <head>
            ...
            <style>
                ...
                .info-box h4 { margin-top: 0; color: #1f2937; }
                .info-list { list-style: none; padding-left: 0; margin: 15px 0; }
                .info-list li { margin: 12px 0; padding-bottom: 8px; border-bottom: 1px solid #f3f4f6; display: flex; justify-content: space-between; align-items: center; }
                ...
                .status-box { background: #fff7ed; padding: 20px; border-radius: 8px; border-left: 4px solid #f59e0b; margin: 20px 0; }
                .footer { text-align: center; color: #6b7280; padding: 20px; font-size: 13px; background: #f9fafb; border-top: 1px solid #e5e7eb; }
            </style>
        </head>
        <body>
            <div class='container'>
                ...
                <div class='content'>
                    <p><strong>Halo, " . htmlspecialchars($nama) . "!</strong></p>
                    <p>Sebuah akun " . htmlspecialchars($jenis_akun) . " telah dibuat untuk Anda di sistem <strong>Sapa Baru</strong>.</p>
                    <div class='info-box'>
                        ...
                        <ul class='info-list'>
                            ...
                            <li>
                                ...
                                <span class='password-code'>" . htmlspecialchars($password_biasa) . "</span>
                            </li>
                        </ul>
                    </div>
                    <div class='status-box'>
                        <h4>⏳ Status Akun: MENUNGGU VERIFIKASI</h4>
        ...
        if (!$this->email->send()) {
            log_message('error', 'Email notifikasi PJ gagal dikirim ke ' . $email_tujuan . ': ' . $this->email->print_debugger());
        }
    }
